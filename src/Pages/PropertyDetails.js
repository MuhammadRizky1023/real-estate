        ...
        <section>
            <div className="container mx-auto min-h-[800px] mb-14">
                ...
                <div className="mb-4 lg:mb-0 flex gap-x-2 text-sm">
                    ...
                    <div className="bg-violet-600 text-white px-3 rounded-full">{house.country}</div>
                </div>
                ...
                <div className='flex flex-col items-start gap-8 lg:flex-row'>
                    ...
                    <div className="flex-1 bg-white  w-full border border-gray-300 rounded-lg px-6 py-8">
                        <div className="flex items-center gap-x-4 mb-8">
                            ...
                            <div className='font-bold text-lg'>
                                ...
                                <Link  to="" className='text-violet-700 text-sm'>View Listening</Link>
                            </div>
                        </div>
                        <form className='flex flex-col gap-y-4'>
                            <input className='border border-gray-300
                             focus:border-violet-700 outline-none rounded
                               w-full px-4 h-14 text-sm'
                                placeholder='Name'
                                type="text" />
                            <input className='border border-gray-300
                            ...
                            placeholder='Message'
                            defaultValue="Hello I am interested in this place"></textarea>
                            <div className='flex gap-x-2'>
                                ...
                                <button className='bg-violet-100 text-violet-700 hover:bg-violet-700 hover:text-white rounded p-4 text-sm w-full transition'>Call</button>
                            </div>
                        </form>
                    </div>
                </div>
